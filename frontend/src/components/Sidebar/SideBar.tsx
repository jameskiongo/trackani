  ...
  return (
    <div className="flex flex-col justify-center items-center h-full">
      <div className="w-full">
        <a href="">
          <div className="flex flex-col py-2 bg-gray-100 hover:bg-gray-200 cursor-pointer w-full items-center justify-center">
            <svg
      ...
      <div className="w-full">
        <a href="">
          <div className="flex flex-col py-2 hover:bg-gray-200 cursor-pointer w-full items-center justify-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="size-9"
              viewBox="0 0 24 24"
